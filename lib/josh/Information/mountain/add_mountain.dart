...
class AddMountainPage extends StatefulWidget {
  @override
  _AddMountainPageState createState() => _AddMountainPageState();
}

class _AddMountainPageState extends State<AddMountainPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tambah Artikel Gunung'),
              ...
              ElevatedButton(
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    context.read<Promountain>().tambahmountain(newMountain);
