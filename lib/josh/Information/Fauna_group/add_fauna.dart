...
class AddFaunaPage extends StatefulWidget {
  @override
  _AddFaunaPageState createState() => _AddFaunaPageState();
}

class _AddFaunaPageState extends State<AddFaunaPage> {
  final _formKey = GlobalKey<FormState>();
  final _namaController = TextEditingController();
  final _imageController = TextEditingController();
  final _contentController = TextEditingController();
  String _kategori = 'darat'; // Nilai default

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tambah Artikel Fauna'),
              ...
              ElevatedButton(
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    context.read<Prohewan>().tambahHewan(newFauna);
