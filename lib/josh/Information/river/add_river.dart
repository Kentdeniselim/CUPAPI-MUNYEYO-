...
class AddRiverPage extends StatefulWidget {
  @override
  _AddRiverPageState createState() => _AddRiverPageState();
}

class _AddRiverPageState extends State<AddRiverPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tambah Artikel Sungai'),
              ...
              ElevatedButton(
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    context.read<Proriver>().tambahriver(newRiver);
